"""E2e test: parse real .tscn files from the open-rpg 4.5.0 project.

These scenes are from gdquest-demos/godot-open-rpg at commit 7619659
("Upgrade to Godot 4.5 & fix Dialogic portraits"), MIT licensed. They are
