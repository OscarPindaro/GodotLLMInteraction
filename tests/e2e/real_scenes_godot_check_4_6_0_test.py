...
Uses the 4.6.0 Godot binary to check scenes from the open-rpg 4.6.0 project.
...
def test_godot_check_only_on_real_scene_4_6_0(scene_name):
    """Godot --check-only should pass on each real scene."""
    binary = godot_binary_path("4.6.0")
    if binary is None:
        pytest.skip("Godot 4.6.0 binary not installed")
