"""E2e test: parse real .tscn files from the open-rpg 4.4.0 project.

These scenes are from gdquest-demos/godot-open-rpg at the 0.4.0 tag
("Godot 4.4 rewrite"), MIT licensed. They are real-world scenes with
...
def test_gamepiece_scene_has_node_hierarchy():
    ...
    assert scene.nodes[2].parent == "PathFollow2D"
