...
Uses the 4.7 Godot binary to check scenes from the open-rpg project.
...
def test_godot_check_only_on_real_scene_4_7_0(scene_name):
    """Godot --check-only should pass on each real scene."""
    binary = godot_binary_path("4.7")
    if binary is None:
        pytest.skip("Godot 4.7 binary not installed")
