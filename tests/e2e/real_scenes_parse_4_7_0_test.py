"""E2e test: parse real .tscn files from the open-rpg 4.7 project.

These scenes are from gdquest-demos/godot-open-rpg at commit b70df69
("Update Godot version to 4.6.2"), MIT licensed. The open-rpg project
has not been updated to Godot 4.7, so the scenes are identical to the
4.6.2 fixtures. They are real-world scenes with scripts, sub-resources,
signals, and various node types.
