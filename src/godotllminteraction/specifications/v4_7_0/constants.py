...
COLOR_ALICE_BLUE = GodotConstant(
    ...
    name="ALICE_BLUE",
    type="Color",
    raw_value="Color(0.9411765, 0.972549, 1, 1)",
)
...
COLOR_ANTIQUE_WHITE = GodotConstant(
    ...
    name="ANTIQUE_WHITE",
    type="Color",
    raw_value="Color(0.98039216, 0.92156863, 0.84313726, 1)",
)
...
COLOR_AQUAMARINE = GodotConstant(
    ...
    name="AQUAMARINE",
    type="Color",
    raw_value="Color(0.49803922, 1, 0.83137256, 1)",
)
...
COLOR_AZURE = GodotConstant(
    ...
    name="AZURE",
    type="Color",
    raw_value="Color(0.9411765, 1, 1, 1)",
)
...
COLOR_BEIGE = GodotConstant(
    ...
    name="BEIGE",
    type="Color",
    raw_value="Color(0.9607843, 0.9607843, 0.8627451, 1)",
)
...
COLOR_BISQUE = GodotConstant(
    ...
    name="BISQUE",
    type="Color",
    raw_value="Color(1, 0.89411765, 0.76862746, 1)",
)
...
COLOR_BLANCHED_ALMOND = GodotConstant(
    ...
    type="Color",
    raw_value="Color(1, 0.92156863, 0.8039216, 1)",
)
...
COLOR_BLUE_VIOLET = GodotConstant(
    ...
    name="BLUE_VIOLET",
    type="Color",
    raw_value="Color(0.5411765, 0.16862746, 0.8862745, 1)",
)
...
COLOR_BROWN = GodotConstant(
    ...
    name="BROWN",
    type="Color",
    raw_value="Color(0.64705884, 0.16470589, 0.16470589, 1)",
)
...
COLOR_BURLYWOOD = GodotConstant(
    ...
    name="BURLYWOOD",
    type="Color",
    raw_value="Color(0.87058824, 0.72156864, 0.5294118, 1)",
)
...
COLOR_CADET_BLUE = GodotConstant(
    ...
    name="CADET_BLUE",
    type="Color",
    raw_value="Color(0.37254903, 0.61960787, 0.627451, 1)",
)
...
COLOR_CHARTREUSE = GodotConstant(
    ...
    name="CHARTREUSE",
    type="Color",
    raw_value="Color(0.49803922, 1, 0, 1)",
)
...
COLOR_CHOCOLATE = GodotConstant(
    ...
    name="CHOCOLATE",
    type="Color",
    raw_value="Color(0.8235294, 0.4117647, 0.11764706, 1)",
)
...
COLOR_CORAL = GodotConstant(
    ...
    name="CORAL",
    type="Color",
    raw_value="Color(1, 0.49803922, 0.3137255, 1)",
)
...
COLOR_CORNFLOWER_BLUE = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.39215687, 0.58431375, 0.92941177, 1)",
)
...
COLOR_CORNSILK = GodotConstant(
    ...
    name="CORNSILK",
    type="Color",
    raw_value="Color(1, 0.972549, 0.8627451, 1)",
)
...
COLOR_CRIMSON = GodotConstant(
    ...
    name="CRIMSON",
    type="Color",
    raw_value="Color(0.8627451, 0.078431375, 0.23529412, 1)",
)
...
COLOR_DARK_BLUE = GodotConstant(
    ...
    name="DARK_BLUE",
    type="Color",
    raw_value="Color(0, 0, 0.54509807, 1)",
)
...
COLOR_DARK_CYAN = GodotConstant(
    ...
    name="DARK_CYAN",
    type="Color",
    raw_value="Color(0, 0.54509807, 0.54509807, 1)",
)
...
COLOR_DARK_GOLDENROD = GodotConstant(
    ...
    name="DARK_GOLDENROD",
    type="Color",
    raw_value="Color(0.72156864, 0.5254902, 0.043137256, 1)",
)
...
COLOR_DARK_GRAY = GodotConstant(
    ...
    name="DARK_GRAY",
    type="Color",
    raw_value="Color(0.6627451, 0.6627451, 0.6627451, 1)",
)
...
COLOR_DARK_GREEN = GodotConstant(
    ...
    name="DARK_GREEN",
    type="Color",
    raw_value="Color(0, 0.39215687, 0, 1)",
)
...
COLOR_DARK_KHAKI = GodotConstant(
    ...
    name="DARK_KHAKI",
    type="Color",
    raw_value="Color(0.7411765, 0.7176471, 0.41960785, 1)",
)
...
COLOR_DARK_MAGENTA = GodotConstant(
    ...
    name="DARK_MAGENTA",
    type="Color",
    raw_value="Color(0.54509807, 0, 0.54509807, 1)",
)
...
COLOR_DARK_OLIVE_GREEN = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.33333334, 0.41960785, 0.18431373, 1)",
)
...
COLOR_DARK_ORANGE = GodotConstant(
    ...
    name="DARK_ORANGE",
    type="Color",
    raw_value="Color(1, 0.54901963, 0, 1)",
)
...
COLOR_DARK_ORCHID = GodotConstant(
    ...
    name="DARK_ORCHID",
    type="Color",
    raw_value="Color(0.6, 0.19607843, 0.8, 1)",
)
...
COLOR_DARK_RED = GodotConstant(
    ...
    name="DARK_RED",
    type="Color",
    raw_value="Color(0.54509807, 0, 0, 1)",
)
...
COLOR_DARK_SALMON = GodotConstant(
    ...
    name="DARK_SALMON",
    type="Color",
    raw_value="Color(0.9137255, 0.5882353, 0.47843137, 1)",
)
...
COLOR_DARK_SEA_GREEN = GodotConstant(
    ...
    name="DARK_SEA_GREEN",
    type="Color",
    raw_value="Color(0.56078434, 0.7372549, 0.56078434, 1)",
)
...
COLOR_DARK_SLATE_BLUE = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.28235295, 0.23921569, 0.54509807, 1)",
)
...
COLOR_DARK_SLATE_GRAY = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.18431373, 0.30980393, 0.30980393, 1)",
)
...
COLOR_DARK_TURQUOISE = GodotConstant(
    ...
    name="DARK_TURQUOISE",
    type="Color",
    raw_value="Color(0, 0.80784315, 0.81960785, 1)",
)
...
COLOR_DARK_VIOLET = GodotConstant(
    ...
    name="DARK_VIOLET",
    type="Color",
    raw_value="Color(0.5803922, 0, 0.827451, 1)",
)
...
COLOR_DEEP_PINK = GodotConstant(
    ...
    name="DEEP_PINK",
    type="Color",
    raw_value="Color(1, 0.078431375, 0.5764706, 1)",
)
...
COLOR_DEEP_SKY_BLUE = GodotConstant(
    ...
    name="DEEP_SKY_BLUE",
    type="Color",
    raw_value="Color(0, 0.7490196, 1, 1)",
)
...
COLOR_DIM_GRAY = GodotConstant(
    ...
    name="DIM_GRAY",
    type="Color",
    raw_value="Color(0.4117647, 0.4117647, 0.4117647, 1)",
)
...
COLOR_DODGER_BLUE = GodotConstant(
    ...
    name="DODGER_BLUE",
    type="Color",
    raw_value="Color(0.11764706, 0.5647059, 1, 1)",
)
...
COLOR_FIREBRICK = GodotConstant(
    ...
    name="FIREBRICK",
    type="Color",
    raw_value="Color(0.69803923, 0.13333334, 0.13333334, 1)",
)
...
COLOR_FLORAL_WHITE = GodotConstant(
    ...
    name="FLORAL_WHITE",
    type="Color",
    raw_value="Color(1, 0.98039216, 0.9411765, 1)",
)
...
COLOR_FOREST_GREEN = GodotConstant(
    ...
    name="FOREST_GREEN",
    type="Color",
    raw_value="Color(0.13333334, 0.54509807, 0.13333334, 1)",
)
...
COLOR_GAINSBORO = GodotConstant(
    ...
    name="GAINSBORO",
    type="Color",
    raw_value="Color(0.8627451, 0.8627451, 0.8627451, 1)",
)
...
COLOR_GOLD = GodotConstant(
    ...
    name="GOLD",
    type="Color",
    raw_value="Color(1, 0.84313726, 0, 1)",
)
...
COLOR_GOLDENROD = GodotConstant(
    ...
    name="GOLDENROD",
    type="Color",
    raw_value="Color(0.85490197, 0.64705884, 0.1254902, 1)",
)
...
COLOR_GRAY = GodotConstant(
    ...
    name="GRAY",
    type="Color",
    raw_value="Color(0.74509805, 0.74509805, 0.74509805, 1)",
)
...
COLOR_GREEN_YELLOW = GodotConstant(
    ...
    name="GREEN_YELLOW",
    type="Color",
    raw_value="Color(0.6784314, 1, 0.18431373, 1)",
)
...
COLOR_HONEYDEW = GodotConstant(
    ...
    name="HONEYDEW",
    type="Color",
    raw_value="Color(0.9411765, 1, 0.9411765, 1)",
)
...
COLOR_HOT_PINK = GodotConstant(
    ...
    name="HOT_PINK",
    type="Color",
    raw_value="Color(1, 0.4117647, 0.7058824, 1)",
)
...
COLOR_INDIAN_RED = GodotConstant(
    ...
    name="INDIAN_RED",
    type="Color",
    raw_value="Color(0.8039216, 0.36078432, 0.36078432, 1)",
)
...
COLOR_INDIGO = GodotConstant(
    ...
    name="INDIGO",
    type="Color",
    raw_value="Color(0.29411766, 0, 0.50980395, 1)",
)
...
COLOR_IVORY = GodotConstant(
    ...
    name="IVORY",
    type="Color",
    raw_value="Color(1, 1, 0.9411765, 1)",
)
...
COLOR_KHAKI = GodotConstant(
    ...
    name="KHAKI",
    type="Color",
    raw_value="Color(0.9411765, 0.9019608, 0.54901963, 1)",
)
...
COLOR_LAVENDER = GodotConstant(
    ...
    name="LAVENDER",
    type="Color",
    raw_value="Color(0.9019608, 0.9019608, 0.98039216, 1)",
)
...
COLOR_LAVENDER_BLUSH = GodotConstant(
    ...
    name="LAVENDER_BLUSH",
    type="Color",
    raw_value="Color(1, 0.9411765, 0.9607843, 1)",
)
...
COLOR_LAWN_GREEN = GodotConstant(
    ...
    name="LAWN_GREEN",
    type="Color",
    raw_value="Color(0.4862745, 0.9882353, 0, 1)",
)
...
COLOR_LEMON_CHIFFON = GodotConstant(
    ...
    name="LEMON_CHIFFON",
    type="Color",
    raw_value="Color(1, 0.98039216, 0.8039216, 1)",
)
...
COLOR_LIGHT_BLUE = GodotConstant(
    ...
    name="LIGHT_BLUE",
    type="Color",
    raw_value="Color(0.6784314, 0.84705883, 0.9019608, 1)",
)
...
COLOR_LIGHT_CORAL = GodotConstant(
    ...
    name="LIGHT_CORAL",
    type="Color",
    raw_value="Color(0.9411765, 0.5019608, 0.5019608, 1)",
)
...
COLOR_LIGHT_CYAN = GodotConstant(
    ...
    name="LIGHT_CYAN",
    type="Color",
    raw_value="Color(0.8784314, 1, 1, 1)",
)
...
COLOR_LIGHT_GOLDENROD = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.98039216, 0.98039216, 0.8235294, 1)",
)
...
COLOR_LIGHT_GREEN = GodotConstant(
    ...
    name="LIGHT_GREEN",
    type="Color",
    raw_value="Color(0.5647059, 0.93333334, 0.5647059, 1)",
)
...
COLOR_LIGHT_PINK = GodotConstant(
    ...
    name="LIGHT_PINK",
    type="Color",
    raw_value="Color(1, 0.7137255, 0.75686276, 1)",
)
...
COLOR_LIGHT_SALMON = GodotConstant(
    ...
    name="LIGHT_SALMON",
    type="Color",
    raw_value="Color(1, 0.627451, 0.47843137, 1)",
)
...
COLOR_LIGHT_SEA_GREEN = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.1254902, 0.69803923, 0.6666667, 1)",
)
...
COLOR_LIGHT_SKY_BLUE = GodotConstant(
    ...
    name="LIGHT_SKY_BLUE",
    type="Color",
    raw_value="Color(0.5294118, 0.80784315, 0.98039216, 1)",
)
...
COLOR_LIGHT_SLATE_GRAY = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.46666667, 0.53333336, 0.6, 1)",
)
...
COLOR_LIGHT_STEEL_BLUE = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.6901961, 0.76862746, 0.87058824, 1)",
)
...
COLOR_LIGHT_YELLOW = GodotConstant(
    ...
    name="LIGHT_YELLOW",
    type="Color",
    raw_value="Color(1, 1, 0.8784314, 1)",
)
...
COLOR_LIME_GREEN = GodotConstant(
    ...
    name="LIME_GREEN",
    type="Color",
    raw_value="Color(0.19607843, 0.8039216, 0.19607843, 1)",
)
...
COLOR_LINEN = GodotConstant(
    ...
    name="LINEN",
    type="Color",
    raw_value="Color(0.98039216, 0.9411765, 0.9019608, 1)",
)
...
COLOR_MAROON = GodotConstant(
    ...
    name="MAROON",
    type="Color",
    raw_value="Color(0.6901961, 0.1882353, 0.3764706, 1)",
)
...
COLOR_MEDIUM_AQUAMARINE = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.4, 0.8039216, 0.6666667, 1)",
)
...
COLOR_MEDIUM_BLUE = GodotConstant(
    ...
    name="MEDIUM_BLUE",
    type="Color",
    raw_value="Color(0, 0, 0.8039216, 1)",
)
...
COLOR_MEDIUM_ORCHID = GodotConstant(
    ...
    name="MEDIUM_ORCHID",
    type="Color",
    raw_value="Color(0.7294118, 0.33333334, 0.827451, 1)",
)
...
COLOR_MEDIUM_PURPLE = GodotConstant(
    ...
    name="MEDIUM_PURPLE",
    type="Color",
    raw_value="Color(0.5764706, 0.4392157, 0.85882354, 1)",
)
...
COLOR_MEDIUM_SEA_GREEN = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.23529412, 0.7019608, 0.44313726, 1)",
)
...
COLOR_MEDIUM_SLATE_BLUE = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.48235294, 0.40784314, 0.93333334, 1)",
)
...
COLOR_MEDIUM_SPRING_GREEN = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0, 0.98039216, 0.6039216, 1)",
)
...
COLOR_MEDIUM_TURQUOISE = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.28235295, 0.81960785, 0.8, 1)",
)
...
COLOR_MEDIUM_VIOLET_RED = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.78039217, 0.08235294, 0.52156866, 1)",
)
...
COLOR_MIDNIGHT_BLUE = GodotConstant(
    ...
    name="MIDNIGHT_BLUE",
    type="Color",
    raw_value="Color(0.09803922, 0.09803922, 0.4392157, 1)",
)
...
COLOR_MINT_CREAM = GodotConstant(
    ...
    name="MINT_CREAM",
    type="Color",
    raw_value="Color(0.9607843, 1, 0.98039216, 1)",
)
...
COLOR_MISTY_ROSE = GodotConstant(
    ...
    name="MISTY_ROSE",
    type="Color",
    raw_value="Color(1, 0.89411765, 0.88235295, 1)",
)
...
COLOR_MOCCASIN = GodotConstant(
    ...
    name="MOCCASIN",
    type="Color",
    raw_value="Color(1, 0.89411765, 0.70980394, 1)",
)
...
COLOR_NAVAJO_WHITE = GodotConstant(
    ...
    name="NAVAJO_WHITE",
    type="Color",
    raw_value="Color(1, 0.87058824, 0.6784314, 1)",
)
...
COLOR_NAVY_BLUE = GodotConstant(
    ...
    name="NAVY_BLUE",
    type="Color",
    raw_value="Color(0, 0, 0.5019608, 1)",
)
...
COLOR_OLD_LACE = GodotConstant(
    ...
    name="OLD_LACE",
    type="Color",
    raw_value="Color(0.99215686, 0.9607843, 0.9019608, 1)",
)
...
COLOR_OLIVE = GodotConstant(
    ...
    name="OLIVE",
    type="Color",
    raw_value="Color(0.5019608, 0.5019608, 0, 1)",
)
...
COLOR_OLIVE_DRAB = GodotConstant(
    ...
    name="OLIVE_DRAB",
    type="Color",
    raw_value="Color(0.41960785, 0.5568628, 0.13725491, 1)",
)
...
COLOR_ORANGE = GodotConstant(
    ...
    name="ORANGE",
    type="Color",
    raw_value="Color(1, 0.64705884, 0, 1)",
)
...
COLOR_ORANGE_RED = GodotConstant(
    ...
    name="ORANGE_RED",
    type="Color",
    raw_value="Color(1, 0.27058825, 0, 1)",
)
...
COLOR_ORCHID = GodotConstant(
    ...
    name="ORCHID",
    type="Color",
    raw_value="Color(0.85490197, 0.4392157, 0.8392157, 1)",
)
...
COLOR_PALE_GOLDENROD = GodotConstant(
    ...
    name="PALE_GOLDENROD",
    type="Color",
    raw_value="Color(0.93333334, 0.9098039, 0.6666667, 1)",
)
...
COLOR_PALE_GREEN = GodotConstant(
    ...
    name="PALE_GREEN",
    type="Color",
    raw_value="Color(0.59607846, 0.9843137, 0.59607846, 1)",
)
...
COLOR_PALE_TURQUOISE = GodotConstant(
    ...
    name="PALE_TURQUOISE",
    type="Color",
    raw_value="Color(0.6862745, 0.93333334, 0.93333334, 1)",
)
...
COLOR_PALE_VIOLET_RED = GodotConstant(
    ...
    type="Color",
    raw_value="Color(0.85882354, 0.4392157, 0.5764706, 1)",
)
...
COLOR_PAPAYA_WHIP = GodotConstant(
    ...
    name="PAPAYA_WHIP",
    type="Color",
    raw_value="Color(1, 0.9372549, 0.8352941, 1)",
)
...
COLOR_PEACH_PUFF = GodotConstant(
    ...
    name="PEACH_PUFF",
    type="Color",
    raw_value="Color(1, 0.85490197, 0.7254902, 1)",
)
...
COLOR_PERU = GodotConstant(
    ...
    name="PERU",
    type="Color",
    raw_value="Color(0.8039216, 0.52156866, 0.24705882, 1)",
)
...
COLOR_PINK = GodotConstant(
    ...
    name="PINK",
    type="Color",
    raw_value="Color(1, 0.7529412, 0.79607844, 1)",
)
...
COLOR_PLUM = GodotConstant(
    ...
    name="PLUM",
    type="Color",
    raw_value="Color(0.8666667, 0.627451, 0.8666667, 1)",
)
...
COLOR_POWDER_BLUE = GodotConstant(
    ...
    name="POWDER_BLUE",
    type="Color",
    raw_value="Color(0.6901961, 0.8784314, 0.9019608, 1)",
)
...
COLOR_PURPLE = GodotConstant(
    ...
    name="PURPLE",
    type="Color",
    raw_value="Color(0.627451, 0.1254902, 0.9411765, 1)",
)
...
COLOR_ROSY_BROWN = GodotConstant(
    ...
    name="ROSY_BROWN",
    type="Color",
    raw_value="Color(0.7372549, 0.56078434, 0.56078434, 1)",
)
...
COLOR_ROYAL_BLUE = GodotConstant(
    ...
    name="ROYAL_BLUE",
    type="Color",
    raw_value="Color(0.25490198, 0.4117647, 0.88235295, 1)",
)
...
COLOR_SADDLE_BROWN = GodotConstant(
    ...
    name="SADDLE_BROWN",
    type="Color",
    raw_value="Color(0.54509807, 0.27058825, 0.07450981, 1)",
)
...
COLOR_SALMON = GodotConstant(
    ...
    name="SALMON",
    type="Color",
    raw_value="Color(0.98039216, 0.5019608, 0.44705883, 1)",
)
...
COLOR_SANDY_BROWN = GodotConstant(
    ...
    name="SANDY_BROWN",
    type="Color",
    raw_value="Color(0.95686275, 0.6431373, 0.3764706, 1)",
)
...
COLOR_SEASHELL = GodotConstant(
    ...
    name="SEASHELL",
    type="Color",
    raw_value="Color(1, 0.9607843, 0.93333334, 1)",
)
...
COLOR_SEA_GREEN = GodotConstant(
    ...
    name="SEA_GREEN",
    type="Color",
    raw_value="Color(0.18039216, 0.54509807, 0.34117648, 1)",
)
...
COLOR_SIENNA = GodotConstant(
    ...
    name="SIENNA",
    type="Color",
    raw_value="Color(0.627451, 0.32156864, 0.1764706, 1)",
)
...
COLOR_SILVER = GodotConstant(
    ...
    name="SILVER",
    type="Color",
    raw_value="Color(0.7529412, 0.7529412, 0.7529412, 1)",
)
...
COLOR_SKY_BLUE = GodotConstant(
    ...
    name="SKY_BLUE",
    type="Color",
    raw_value="Color(0.5294118, 0.80784315, 0.92156863, 1)",
)
...
COLOR_SLATE_BLUE = GodotConstant(
    ...
    name="SLATE_BLUE",
    type="Color",
    raw_value="Color(0.41568628, 0.3529412, 0.8039216, 1)",
)
...
COLOR_SLATE_GRAY = GodotConstant(
    ...
    name="SLATE_GRAY",
    type="Color",
    raw_value="Color(0.4392157, 0.5019608, 0.5647059, 1)",
)
...
COLOR_SNOW = GodotConstant(
    ...
    name="SNOW",
    type="Color",
    raw_value="Color(1, 0.98039216, 0.98039216, 1)",
)
...
COLOR_SPRING_GREEN = GodotConstant(
    ...
    name="SPRING_GREEN",
    type="Color",
    raw_value="Color(0, 1, 0.49803922, 1)",
)
...
COLOR_STEEL_BLUE = GodotConstant(
    ...
    name="STEEL_BLUE",
    type="Color",
    raw_value="Color(0.27450982, 0.50980395, 0.7058824, 1)",
)
...
COLOR_TAN = GodotConstant(
    ...
    name="TAN",
    type="Color",
    raw_value="Color(0.8235294, 0.7058824, 0.54901963, 1)",
)
...
COLOR_TEAL = GodotConstant(
    ...
    name="TEAL",
    type="Color",
    raw_value="Color(0, 0.5019608, 0.5019608, 1)",
)
...
COLOR_THISTLE = GodotConstant(
    ...
    name="THISTLE",
    type="Color",
    raw_value="Color(0.84705883, 0.7490196, 0.84705883, 1)",
)
...
COLOR_TOMATO = GodotConstant(
    ...
    name="TOMATO",
    type="Color",
    raw_value="Color(1, 0.3882353, 0.2784314, 1)",
)
...
COLOR_TURQUOISE = GodotConstant(
    ...
    name="TURQUOISE",
    type="Color",
    raw_value="Color(0.2509804, 0.8784314, 0.8156863, 1)",
)
...
COLOR_VIOLET = GodotConstant(
    ...
    name="VIOLET",
    type="Color",
    raw_value="Color(0.93333334, 0.50980395, 0.93333334, 1)",
)
...
COLOR_WEB_GRAY = GodotConstant(
    ...
    name="WEB_GRAY",
    type="Color",
    raw_value="Color(0.5019608, 0.5019608, 0.5019608, 1)",
)
...
COLOR_WEB_GREEN = GodotConstant(
    ...
    name="WEB_GREEN",
    type="Color",
    raw_value="Color(0, 0.5019608, 0, 1)",
)
...
COLOR_WEB_MAROON = GodotConstant(
    ...
    name="WEB_MAROON",
    type="Color",
    raw_value="Color(0.5019608, 0, 0, 1)",
)
...
COLOR_WEB_PURPLE = GodotConstant(
    ...
    name="WEB_PURPLE",
    type="Color",
    raw_value="Color(0.5019608, 0, 0.5019608, 1)",
)
...
COLOR_WHEAT = GodotConstant(
    ...
    name="WHEAT",
    type="Color",
    raw_value="Color(0.9607843, 0.87058824, 0.7019608, 1)",
)
...
COLOR_WHITE_SMOKE = GodotConstant(
    ...
    name="WHITE_SMOKE",
    type="Color",
    raw_value="Color(0.9607843, 0.9607843, 0.9607843, 1)",
)
...
COLOR_YELLOW_GREEN = GodotConstant(
    ...
    name="YELLOW_GREEN",
    type="Color",
    raw_value="Color(0.6039216, 0.8039216, 0.19607843, 1)",
)
