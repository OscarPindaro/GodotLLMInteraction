"""Auto-generated spec for Godot v4_7_0. Do not edit by hand."""
...
# === GENERATED: GodotArgumentMetaEnum (run: gli specifications sync-enums --version v4_7_0) ===
...
class Specification4_7_0(BaseModel):
    """Full Godot v4_7_0 GDExtension API dump, mirroring the top-level sections of extension_api.json."""
